...
class _SpaceCheckoutScreenState extends State<SpaceCheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(context.l10n.spaceCheckout),
        elevation: 0,
      ),
      ...
      builder: (_) => AlertDialog(
        ...
        title: Column(
          children: [
            ...
            SizedBox(height: 16),
            Text(context.l10n.bookingConfirmed1),
          ],
        ),
        content: Column(
          ...
          children: [
            Text(
              context.l10n.yourSpaceBookingHasBeenSuccessfullyCreated,
            ...
            SizedBox(height: 12),
            Text(
              context.l10n.pleaseSaveThisCodeForYourRecords,
              style: TextStyle(
                fontSize: 12,
                color: Colors.grey,
              ),
        ...
        actions: [
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(context.l10n.backToHome1),
            ),
          ),
        ],
      ),
